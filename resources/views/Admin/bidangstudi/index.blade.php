...
<div class="flex flex-wrap -mx-3 mb-4">
    <div class="w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-4 wrap-break-word bg-white shadow-soft-xl rounded-2xl">
            <div class="p-4 flex justify-between items-center">
                <h5 class="font-bold">Bidang Studi</h5>
                <a href="{{ route('admin.bidangstudi.create') }}" class="btn-admin">Tambah Bidang Studi</a>
            </div>
        ...
        <tr>
            ...
            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
              <a href="{{ route('admin.bidangstudi.edit', $item) }}" class="btn-admin-secondary">Edit</a>
              <form action="{{ route('admin.bidangstudi.destroy', $item) }}" method="POST" class="inline-block ml-2" onsubmit="return confirm('Yakin ingin dihapus?')">
                    @csrf
                    @method('DELETE')
